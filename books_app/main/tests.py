...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        created_author = Author.query.filter_by(name='New Author').one()
        self.assertIsNotNone(created_author)
        self.assertEqual(created_author.name, 'New Author')
        self.assertEqual(created_author.biography, 'This is a bio')
    ...
    def test_create_genre(self):
        ...
        created_genre = Genre.query.filter_by(name='New Genre').one()
